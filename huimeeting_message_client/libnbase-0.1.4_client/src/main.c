...
int main(int argc, char **argv)
{
  ...
  for(i = 0; i < 2000; i ++)
  {
    ...
    sv->send_flag = 0;
    sv->push_data(sv, WAN_MESSAGE_SERVER_IP, 6714, "", 600, TCP_T, 0);
  ...
  */
  ...
  usleep(sv->sleep_usec * 10);
  sv->terminate_node(sv, WAN_MESSAGE_SERVER_IP, 6714, TCP_T, 0);
